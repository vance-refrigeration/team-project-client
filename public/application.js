...
var config = {
  apiOrigins: {
    ...
    production: 'https://obscure-springs-81184.herokuapp.com'
  }
};
...
var onAddToCart = function onAddToCart(event) {
  ...
  var product = { name: name, description: description, price: price, id: id };
  var data = { product: product };
  api.addToCart(data).then(ui.addToCartSuccess).catch(ui.addToCartFailure);
};
...
var onRemoveProduct = function onRemoveProduct(event) {
  ...
  api.removeFromCart(data).then(ui.removeProductSuccess).then(function () {
    $(row).empty();
  }).then(ui.calculateTotal).catch(ui.removeProductFailure);
};

var populateProducts = function populateProducts() {
  api.populate().then(ui.populateSuccess).catch(ui.populateFailure);
};

var emptyUserCart = function emptyUserCart() {
  api.emptyUserCart();
};

var viewCart = function viewCart() {
  ui.viewCartSuccess();
};
...
var store = __webpack_require__(2);
var productsTemplate = __webpack_require__(20);
var cartTemplate = __webpack_require__(37);
...
var populateFailure = function populateFailure() {
...
var viewCartSuccess = function viewCartSuccess() {
  var cartHtml = cartTemplate({ products: store.user.cart });
...
var removeProductSuccess = function removeProductSuccess(data) {
  store.user = data.user;
  if (store.user.cart.length === 0) {
...
module.exports = {
  ...
  populateFailure: populateFailure,
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n<div class=\"col-md-4 col-sm-6\">\n  <div class=\"panel panel-default\">\n    <div class=\"panel-heading\"><h3>"
    ...
    + "\" data-price=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.price : stack1), depth0))
    + "\" class=\"btn btn-primary display-when-logged-in\" id=\"add-to-cart\">Add To Cart</button>\n    </div>\n  </div>\n</div>\n";
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "      <tr data-id=\""
    ...
    + "</td>\n        <td>\n          <button data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" class=\"removeProduct btn btn-danger\">Remove From Cart</button>\n        <td>\n      </tr>\n";
},"4":function(container,depth0,helpers,partials,data) {
    return "  <p>You haven't added anything yet! Click on the product you would like to add to the cart.</p>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;
...
var onGetAllOrders = function onGetAllOrders(event) {
  // console.log('Get products event invoked')
  event.preventDefault();
  $('#getOrdersBody').empty();
  // console.log('Target is', event.target)
  api.getOrders().then(ui.getOrdersSuccess).catch(ui.getOrdersFailure);
};
...
var onCreateOrder = function onCreateOrder() {
  ...
  // event.preventDefault()
  // console.log('Target is', event.target)
  api.createOrder().then(ui.createOrderSuccess).catch(ui.createOrderFailure);
};
...
var stripeSubmit = function stripeSubmit() {
  var cartTotal = 0;
  for (var i = 0; i < store.user.cart.length; i++) {
    cartTotal += parseInt(store.user.cart[i].price);
  }
...
var makePayment = function makePayment(event) {
  event.preventDefault();
  stripeSubmit();
};
...
var ordersTemplate = __webpack_require__(41);
var store = __webpack_require__(2);
...
var getOrdersSuccess = function getOrdersSuccess(data) {
  ...
  for (var i = 0; i < data.orders.length; i++) {
    var orderTotal = 0;
    data.orders[i].orderItems.forEach(function (item) {
      orderTotal += parseInt(item.price);
    });
    data.orders[i].orderTotalCost = orderTotal;
  }
  var oldOrdersHtml = ordersTemplate({ orders: data.orders });
  $('#getOrdersBody').append(oldOrdersHtml);
  $('#getOrdersMessageModal').modal('show');
};

var getOrdersFailure = function getOrdersFailure() {};
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "<h4>Order ID:  "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "</h4>\n<table class=\"table\">\n  <thead>\n    <tr>\n      <th>Name</th>\n      <th>Description</th>\n      <th>Price</th>\n      <th></th>\n    </tr>\n  </thead>\n  <tbody>\n"
    + ((stack1 = helpers.blockHelperMissing.call(depth0,alias1(((stack1 = blockParams[0][0]) != null ? stack1.orderItems : stack1), depth0),{"name":"order.orderItems","hash":{},"fn":container.program(3, data, 0, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "    <tr>\n      <td><h5>Total Cost: $"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.orderTotalCost : stack1), depth0))
    + "</h5></td>\n    </tr>\n  </tbody>\n  <table>\n";
  ...
  return "    <tr>\n      <td>"
    ...
    return "<p>You don't have any past orders yet.</p>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;
